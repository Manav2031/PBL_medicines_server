...
exports.sendMail = (req, res) => {
  ...
  const mailOptions = {
    ...
    html: `<h4>Hello</h4><p>Your patients medical prescription is generated by hospital please check that at :<a href='http://localhost:3000/consent/${req.body._id}'>Click Here</a></p><h4>Thank You !!</h4>`,// Replace with the body of your email
  };
